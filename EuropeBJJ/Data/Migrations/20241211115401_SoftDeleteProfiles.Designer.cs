...
namespace EuropeBJJ.Data.Migrations
{
    ...
    [Migration("20241211115401_SoftDeleteProfiles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EuropeBJJ.Data.Models.EventAccount", b =>
                {
            ...
            modelBuilder.Entity("EuropeBJJ.Data.Models.EventProfile", b =>
                {
                    b.Property<int>("EventId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("EventsProfiles");
                });

            modelBuilder.Entity("EuropeBJJ.Data.Models.Profile", b =>
                {
                    b.Property<int>("ProfileId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuropeBJJ.Data.Models.Sponsor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Image = "/img/BornWinner.jpg",
                            IsRemoved = false,
                            Link = "https://www.bornwinner.bg",
                            Name = "Born Winner"
                        },
                        new
                        {
                            Id = 2,
                            Image = "/img/groundgame.jpg",
                            IsRemoved = false,
                            Link = "https://groundgame.com/",
                            Name = "Ground Game"
                        },
                        new
                        {
                            Id = 3,
                            Image = "/img/FUJI_Mats.jpg",
                            IsRemoved = false,
                            Link = "https://fujimats.com/",
                            Name = "FUJI Mats"
                        });
                });
            ...
            modelBuilder.Entity("EuropeBJJ.Data.Models.Tournament", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Sofia",
                            Country = "Bulgaria",
                            Date = new DateTime(2024, 12, 11, 13, 54, 0, 855, DateTimeKind.Local).AddTicks(7156),
                        ...
                        new
                        {
                            ...
                            City = "Sofia",
                            Country = "Bulgaria",
                            Date = new DateTime(2024, 12, 11, 13, 54, 0, 855, DateTimeKind.Local).AddTicks(7201),
                            Discriminator = "Tournament",
                        ...
                        new
                        {
                            ...
                            City = "Sofia",
                            Country = "Bulgaria",
                            Date = new DateTime(2024, 12, 11, 13, 54, 0, 855, DateTimeKind.Local).AddTicks(7206),
                            Discriminator = "Tournament",
                        ...
                        new
                        {
                            ...
                            City = "Lisbon",
                            Country = "Portugal",
                            Date = new DateTime(2024, 12, 11, 13, 54, 0, 855, DateTimeKind.Local).AddTicks(7209),
                            Discriminator = "Tournament",
                        ...
                        new
                        {
                            ...
                            City = "Sofia",
                            Country = "Bulgaria",
                            Date = new DateTime(2024, 12, 11, 13, 54, 0, 855, DateTimeKind.Local).AddTicks(7212),
                            Discriminator = "Tournament",
                            Image = "https://smoothcomp.com/pictures/t/5170482-d6y7/sjjifbf-sofia-winter-open-2025-gi-no-gi.jpg",
                            IsRemoved = false,
                            Link = "https://sjjif.smoothcomp.com/en/event/20819",
                            Name = "SJJIFBF Sofia Winter Open 2025 Gi & No-Gi "
                        });
                });
            ...
            modelBuilder.Entity("EuropeBJJ.Data.Models.EventAccount", b =>
                {
                    ...
                    b.HasOne("EuropeBJJ.Data.Models.Event", "Event")
            ...
            modelBuilder.Entity("EuropeBJJ.Data.Models.EventProfile", b =>
                {
                    ...
                    b.HasOne("EuropeBJJ.Data.Models.Profile", "Profile")
