...
this line in Program.cs :"string email = "admin@gmail.com";"). You might get an error related to use roles when launching the app for the 1st time , just launch it again and it should work.
